...
select * from usuarios;
select id_usuario from usuarios where correo = 'invitado@gmail.com' and password = '123456';
...
insert into usuarios (nombre, apellido, telefono, correo, password, peso_actual, altura_actual, id_genero, fecha_registro, id_rol)
values ('usuario invitado' ,'usuario invitado', '3100000', 'correoInvitado@gmail.com', 'invitado123', 40 ,170, 1, now(), 0);

insert into usuarios (nombre, apellido, telefono, correo, password, peso_actual, altura_actual, id_genero, fecha_registro, id_rol)
values ('usuario administrador' ,'usuario administrador', '3100000', 'correoAdministrador@gmail.com', 'administrador123', 40 ,170, 1, now(), 1);
